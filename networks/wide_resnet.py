...
class Wide_ResNet(nn.Module):
    def __init__(self, depth, widen_factor, dropout_rate, num_classes,bias=True):
        ...
        self.layer1 = self._wide_layer(wide_basic, nStages[1], n, dropout_rate, stride=1,bias=bias)

        self.layer2 = self._wide_layer(wide_basic, nStages[2], n, dropout_rate, stride=2,bias=bias)
        self.layer3 = self._wide_layer(wide_basic, nStages[3], n, dropout_rate, stride=2,bias=bias)
